import { c as createComponent, m as maybeRenderHead, b as renderTemplate, a as createAstro, d as addAttribute, r as renderComponent } from './astro/server_ClqkolyD.mjs';
import 'kleur/colors';
import 'clsx';
...
}, "C:/Users/NabilAS/astro/devbook_shop/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- en vez de renderizar en id.astro renderizamos aqui -->${maybeRenderHead()}<a${addAttribute(url, "href")} title="Comprar libro" target="_blank" rel="noopener noreferrer" class="text-balance inline-flex gap-4 items-center bg-yellow-400 hover:bg-yellow-500 active:bg-yellow-600 text-black font-bold py-2 px-4 rounded-lg border border-yellow-500 transition duration-200 ease-in-out hover:scale-105 justify-center text-center">
Comprar en Amazon ${countryName} ${renderComponent($$result, "AmazonLogo", $$AmazonLogo, {})} </a>`;
}, "C:/Users/NabilAS/astro/devbook_shop/src/components/BuyButton.astro", void 0);

const $$file = "C:/Users/NabilAS/astro/devbook_shop/src/components/BuyButton.astro";
const $$url = undefined;

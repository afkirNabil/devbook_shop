import { c as createComponent, a as createAstro, f as renderHead, g as renderSlot, b as renderTemplate, r as renderComponent, u as unescapeHTML } from '../chunks/astro/server_ClqkolyD.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
...
}, "C:/Users/NabilAS/astro/devbook_shop/src/layouts/main.astro", void 0);
...
const html = () => "<div class=\"grid place-items-center h-screen content-center\">\n <div class=\"py-2 px-4 bg-purple-500 text-white font-semibold rounded-lg shadow-md\">\n  Tailwind classes also work in Markdown!\n </div>\n <a href=\"/\" class=\"p-4 underline hover:text-purple-500 transition-colors ease-in-out duration-200\">\n  Go home\n </a>\n</div>";
				...
				const file = "C:/Users/NabilAS/astro/devbook_shop/src/pages/markdown-page.md";
